...
public interface StudentApplicationLayerInterface 
{
	 ...
	 * 
	 * @param matric The Student's matric number
	 * @param name The Student's updated name
	 * @param programme The Student's updated programme
	 ...
	 * 
	 * @param matric The matric number of the Student to get
	 ...
	 * 
	 * @param matric The matric number of the Student to remove
