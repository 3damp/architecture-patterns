...
public class StudentDataLayer implements StudentDataLayerInterface {
	// The data store holding the Student details. We use a HashMap for
	// simplicity
	...
	public boolean addStudent(Student student) {
		...
		if (students.containsKey(student.getMatric())) {
			...
			// No Student with that matric number exists. Add Student to data
			// store
	...
	public Student getStudent(String matric) {
		...
		// If no Student with that matric number is stored in the data store,
		// then
		// the previous operation will have returned null. Therefore we simply
		// return
